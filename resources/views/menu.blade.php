...
<div class="container mx-auto p-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div class="bg-gradient-to-r from-blue-500 to-blue-700 text-white rounded-xl p-6 shadow-lg transform hover:scale-105 transition duration-300 ease-in-out">
            ...
            <a href="{{ route('cuentas.index') }}" class="bg-white text-blue-700 font-semibold px-5 py-2 rounded-full transition duration-300 ease-in-out hover:bg-blue-100">
                Ver Cuentas
            </a>
        </div>
        ...
        <div class="bg-gradient-to-r from-green-500 to-green-700 text-white rounded-xl p-6 shadow-lg transform hover:scale-105 transition duration-300 ease-in-out">
            ...
            <a href="{{ route('prestamos') }}" class="bg-white text-green-700 font-semibold px-5 py-2 rounded-full transition duration-300 ease-in-out hover:bg-green-100">
                Ver Préstamos
            </a>
        </div>
        ...
        <div class="bg-gradient-to-r from-purple-500 to-purple-700 text-white rounded-xl p-6 shadow-lg transform hover:scale-105 transition duration-300 ease-in-out">
            ...
            <a href="{{ route('tarjetas_credito') }}" class="bg-white text-purple-700 font-semibold px-5 py-2 rounded-full transition duration-300 ease-in-out hover:bg-purple-100">
                Ver Tarjetas
            </a>
        </div>
        ...
        <div class="bg-gradient-to-r from-yellow-500 to-yellow-600 text-white rounded-xl p-6 shadow-lg transform hover:scale-105 transition duration-300 ease-in-out">
            ...
            <a href="{{ route('pago_servicios') }}" class="bg-white text-yellow-700 font-semibold px-5 py-2 rounded-full transition duration-300 ease-in-out hover:bg-yellow-100">
                Pagar Servicios
            </a>
        </div>
        ...
        <div class="bg-gradient-to-r from-red-500 to-red-700 text-white rounded-xl p-6 shadow-lg transform hover:scale-105 transition duration-300 ease-in-out">
            ...
            <a href="{{ route('transferencias') }}" class="bg-white text-red-700 font-semibold px-5 py-2 rounded-full transition duration-300 ease-in-out hover:bg-red-100">
                Hacer Transferencia
            </a>
        </div>
