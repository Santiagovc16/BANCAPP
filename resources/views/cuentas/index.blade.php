...
<div class="container mx-auto p-6">
    <a href="{{ route('menu') }}" class="bg-blue-500 text-white font-semibold px-4 py-2 rounded hover:bg-blue-700 transition duration-300 ease-in-out mb-6 inline-block">
